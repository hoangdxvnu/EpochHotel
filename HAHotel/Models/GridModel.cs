...
namespace HAHotel.Models
{
    public class GridModel<T>
    {
        ...
        public string GeneratePagination()
        {
            ...
            builder.Append($"<li class=\"paginate_button previous {(CurrentPage == 1 ? "disabled" : "")}\" id=\"dataTables - example_previous\">");
            ...
            {
                builder.Append($"<li class=\"paginate_button {(CurrentPage == i ? "active" : "")}\" id=\"dataTables - example_previous\">");
                builder.Append($"<a href=\"{BaseUrl + "?p=" + i}\" aria-controls=\"dataTables-example\" data-dt-idx=\"{i}\" tabindex=\"0\">{i}</a>");
                builder.Append("</li>");
            }
            builder.Append($"<li class=\"paginate_button next {(CurrentPage == pageNumber ? "disabled" : "")}\" id=\"dataTables - example_previous\">");
